...
func (in *BackstageTenantConfigList) DeepCopyInto(out *BackstageTenantConfigList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]BackstageTenantConfig, len(*in))
		for i := range *in {
...
func (in *BackstageTenantConfigList) DeepCopy() *BackstageTenantConfigList {
	...
	out := new(BackstageTenantConfigList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BackstageTenantConfigSpec) DeepCopy() *BackstageTenantConfigSpec {
	...
	out := new(BackstageTenantConfigSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BackstageTenantConfigStatus) DeepCopyInto(out *BackstageTenantConfigStatus) {
	*out = *in
	if in.TeamNames != nil {
		in, out := &in.TeamNames, &out.TeamNames
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.TenantInventory != nil {
		in, out := &in.TenantInventory, &out.TenantInventory
		*out = make(map[string]TenantResourceInventory, len(*in))
...
func (in *BackstageTenantConfigStatus) DeepCopy() *BackstageTenantConfigStatus {
	...
	out := new(BackstageTenantConfigStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TenantResourceInventory) DeepCopyInto(out *TenantResourceInventory) {
	*out = *in
	if in.Entries != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TenantResourceInventory.
func (in *TenantResourceInventory) DeepCopy() *TenantResourceInventory {
	if in == nil {
		return nil
	}
	out := new(TenantResourceInventory)
	in.DeepCopyInto(out)
	return out
}
